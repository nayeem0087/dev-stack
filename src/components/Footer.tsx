...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-gray-100 py-12 px-6 md:px-12 mt-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <div className="flex items-center gap-2 mb-4">
            <div className="w-6 h-6 rounded brand-gradient flex items-center justify-center text-white text-xs font-bold">DS</div>
            <span className="font-bold text-gray-800">Dev Stack</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto border-t border-gray-100 mt-12 pt-6 flex justify-between text-xs text-gray-400">
